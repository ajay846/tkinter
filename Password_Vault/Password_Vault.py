...
#Create a window to get the "Access Key" or simply "Password"
access_window = Tk()
    ...
    try:
        ...
        def check_access():
            ...
            if passKey == password:
                ...
                #This window will display all the stored passwords -> "passwords_window"
                passwords_window = Tk()
                ...
                def getNewPws():
                    ...
                    #This window will take new passwords and store it in the database -> "add_win"
                    add_win = Tk()
                    ...
                    def add():
                        if for_.get() == "" or username.get() == "" or password_.get() == "":
                            ...
                            try:
                                ...
                                #Open success window to display a success message
                                success_win = Tk()
                                ...
                                webbrowser.open("https://www.instagram.com/iamchintu.u", new=2) #DM Me On Instagram For Any Queries
                            except:
                                error_win = Tk()
                ...
                if subCursor.rowcount == 0:
                    ...
                    label_msg.pack()
                else:                   #Display all the stored passwords
                    for data in results:
...
'''
If Someone Could Help Me With The Delete Button It'd Be Of A Great Help!
---------------------------------------------------------------------------------
Any Queries DM Me On My Instagram -> https://www.instagram.com/iamchintu.u
Username: iamchintu.u
'''
